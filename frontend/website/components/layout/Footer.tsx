        ...
        <div className="py-12 lg:py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mb-8 items-start">
            ...
            <div className="text-left">
              <h4 className="font-dirk font-black text-h5 uppercase mb-4 text-white">
                Quick Links
              </h4>
              <nav className="space-y-3">
                {FOOTER_LINKS.slice(0, 6).map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="block text-gray-1 hover:text-light-green transition-colors duration-200 font-montserrat font-normal text-base"
                  >
                    {link.label}
                  </Link>
                ))}
                ...
                {SOCIAL_LINKS.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      onClick={() => Analytics.clickedSocialMediaFooter(social.label)}
                      className="text-gray-1 hover:text-light-green transition-colors duration-200"
                      title={social.label}
                    >
            ...
            <div className="text-left lg:text-right">
              ...
              <div>
                <a
                  ...
                  onClick={() => Analytics.clickedEmailFooter()}
                  className="text-gray-1 hover:text-light-green transition-colors duration-200 font-montserrat font-normal text-base"
                >
          ...
          {/* Bottom Border */}
          <div className="border-t border-dark-green/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-gray-1 font-montserrat font-normal text-body-2">
                © {new Date().getFullYear()} Recess Sports LLC. All rights reserved. LeagueFindr is a product of Recess Sports LLC.
              </p>
              ...
              <div className="flex space-x-6">
                <Link
                  href="/privacy"
                  className="text-gray-1 hover:text-light-green transition-colors duration-200 font-montserrat text-body-2"
                >
                  Privacy
                </Link>
                <Link
